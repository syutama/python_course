...
# print(float(num_char), type(float(num_char)))
...
# TODO: Write a program that calculates the Body Mass Index (BMI) from a user's weight and height.
# NOTE: BMI = weight / (height * height)

# TOPIC 5: Number manipulation and f-string
# print(8 / 3)
# print(8 // 3)
# print(round(8 / 3))
# print(round(8 / 3, 2))
...
# TODO: Create a program using maths and f-strings that tells us how many weeks we have left until pension.
